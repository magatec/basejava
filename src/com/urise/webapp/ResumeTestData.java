...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        ContactString tel = new ContactString("+7(921) 855-0482");
        ContactString skype = new ContactString("skype:grigory.kislin");
        ContactString mail = new ContactString("gkislin@yandex.ru");
        ContactString linkedin = new ContactString("https://www.linkedin.com/in/gkislin");
        ContactString github = new ContactString("https://github.com/gkislin");
        ContactString stack = new ContactString("https://stackoverflow.com/users/548473");
        ContactString homepage = new ContactString("http://gkislin.ru/");

        EnumMap<ContactSection, ContactString> contacts = new EnumMap<>(ContactSection.class);
        contacts.put(ContactSection.TELEPHONE, tel);
        contacts.put(ContactSection.SKYPE, skype);
        contacts.put(ContactSection.MAIL, mail);
        contacts.put(ContactSection.LINKEDIN, linkedin);
        contacts.put(ContactSection.GITHUB, github);
        contacts.put(ContactSection.STACKOVERFLOW, stack);
        contacts.put(ContactSection.HOMEPAGE, homepage);
        ...
        Organisation org = new Organisation("Java Online Projects", "http://javaops.ru/", workPeriodList);
        ...
        Organisation org1 = new Organisation("Wrike", "https://www.wrike.com/", workPeriod1List);
        ...
        Organisation org2 = new Organisation("RIT Center", workPeriod2List);
        ...
        Organisation org3 = new Organisation("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/", workPeriod3List);
        ...
        Organisation org4 = new Organisation("Yota", "https://www.yota.ru/", workPeriod4List);
        organisationList.add(org4);
        ...
        Organisation org5 = new Organisation("Enkata", "http://enkata.com/", workPeriod5List);
        organisationList.add(org5);
        ...
        Organisation org6 = new Organisation("Siemens AG", "https://www.siemens.com/ru/ru/home.html", workPeriod6List);
        organisationList.add(org6);
        ...
        Organisation org7 = new Organisation("Alcatel", "http://www.alcatel.ru/", workPeriod7List);
        organisationList.add(org7);

        List<Organisation> educOrganisationList = new ArrayList<>();
        ...
        Organisation educOrg = new Organisation("Coursera", "https://www.coursera.org/course/progfun", educPeriodList);
        educOrganisationList.add(educOrg);
        ...
        Organisation educOrg1 = new Organisation("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366", educPeriodList1);
        educOrganisationList.add(educOrg1);
        ...
        Organisation educOrg2 = new Organisation("Siemens AG", "http://www.siemens.ru/", educPeriodList2);
        educOrganisationList.add(educOrg2);
        ...
        Organisation educOrg3 = new Organisation("Alcatel", "http://www.alcatel.ru/", educPeriodList3);
        educOrganisationList.add(educOrg3);
        ...
        Organisation educOrg4 = new Organisation("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "http://www.ifmo.ru/", educPeriodList4);
        educOrganisationList.add(educOrg4);
        ...
        Organisation educOrg5 = new Organisation("Заочная физико-техническая школа при МФТИ", "http://www.school.mipt.ru/", educPeriodList5);
        educOrganisationList.add(educOrg5);

        AbstractSection listSection = new ListSection(list);
        AbstractSection qualificationList = new ListSection(qualifications);
        AbstractSection experience = new OrganisationSection(organisationList);
        AbstractSection education = new OrganisationSection(educOrganisationList);
        ...
        for (Map.Entry<ContactSection, ContactString> entry : contacts.entrySet()) {
            System.out.println(entry.getKey().getTitle() + "  " + entry.getValue().getContact());
        }
